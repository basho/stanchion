...
process_acl_contents([{Name, Value} | RestObjects], Acl) ->
    _ = logger:debug("Object name: ~p", [Name]),
    case Name of
        <<"owner">> ->
...
process_grant([{Name, Value} | RestObjects], Grant) ->
    case Name of
        ...
        <<"permissions">> ->
            ...
            _ = logger:debug("Perms value: ~p", [Value]),
